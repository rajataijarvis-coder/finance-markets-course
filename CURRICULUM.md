# 📋 Financial Markets Course: Full Curriculum

## Course Structure
- **35 modules** organized in 5 phases
...
### Week 1: Foundations + Core Markets Start
- **Day 1**: Modules 1-2 (Money + System Map)
- **Day 2**: Modules 3-4 (Interest Rates + Risk/Return)
- **Day 3**: Module 5 (Market Participants)
- **Day 4**: Module 6 (Equity Markets)
- **Day 5**: Module 7 (Fixed Income)
- **Day 6**: Module 8 (Money Markets)
- **Day 7**: Review + Quiz Week 1

### Week 2: Core Markets Continue + Infrastructure
- **Day 8**: Modules 9-10 (Forex + Commodities)
- **Day 9**: Modules 11-12 (Futures/Forwards + Options)
- **Day 10**: Module 13 (Swaps)
- **Day 11**: Modules 14-15 (Credit + Alternatives)
- **Day 12**: Module 16 (Stock Exchanges)
- **Day 13**: Modules 17-18 (Clearing + Market Makers)
- **Day 14**: Review + Quiz Week 2

### Week 3: Central Banking + Practical
- **Day 15**: Modules 19-20 (Trading + Regulation)
- **Day 16**: Modules 21-22 (Data + Electronic Trading)
- **Day 17**: Module 23 (Central Banks)
- **Day 18**: Module 24-25 (Monetary Policy + Inflation)
- **Day 19**: Modules 26-27 (Currency + Stability)
- **Day 20**: Module 28 (Crisis Response)
- **Day 21**: Review + Quiz Week 3

### Week 4: Practical Applications
- **Day 22**: Modules 29-30 (News + Indicators)
- **Day 23**: Module 31 (Company Analysis)
- **Day 24**: Module 32 (Valuation)
- **Day 25**: Module 33 (Portfolio Theory)
- **Day 26**: Module 34 (Behavioral Finance)
- **Day 27**: Module 35 (Fintech + Crypto)
- **Day 28**: Final Review + Course Completion
